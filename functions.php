...
{
    wp_enqueue_style("bootstrap.css", get_theme_file_uri("inc/css/bootstrap.min.css"), array(), "5.1", "all");
    ...
    wp_enqueue_style("blog.css", get_theme_file_uri("inc/css/blog.css"), array(), "5.1", "all");
    wp_enqueue_style("fonts.css", get_theme_file_uri("fonts.css"), array(), "1.0", "all");
}
